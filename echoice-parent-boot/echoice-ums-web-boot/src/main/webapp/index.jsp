...
<%@page import="org.echoice.modules.spring.SpringContextHolder"%>
<%@page import="org.echoice.ums.dao.EcPermissionDao"%>
...
<html>
  ...
  <body>
    <%
    	boolean isPm=true;
    	/**
    	EcPermissionDao permissionDao=(EcPermissionDao)SpringContextHolder.getBean("ecPermissionDao");
    	String userAlias=CasUmsUtil.getUser(request);
    	String objAlias="ahecm_menu_ums";
    	String accessAlias="view";
    	isPm=permissionDao.isAssignPermission(userAlias, objAlias, accessAlias);
		**/
    	if(isPm){
     %>
